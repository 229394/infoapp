...
// 					select.appendChild(option);
		...
		$("#btn_submit").click(function() {
			...
			if ($.trim(userId.val()) == "") {
				msg += "用户登录名不能为空!";
				userId.focus();
			} else if (!/^\w{4,20}$/.test(userId.val())) {
				msg += "用户登录名长度必须在4-20之间!";
				userId.focus();
			}
			//else if (isExist) {
			//	msg += "用户登录名已经被注册!";
			...
			<table class="table-condensed">
				<tbody>
					...
					<tr>
						...
						<td>
							<select class="btn btn-default" id="deptSelect" name="dept.id">
							</select>
						</td>
					</tr>
					<tr>
						...
						<td>
							<select class="btn btn-default" id="jobSelect" name="job.code">
							</select>
						</td>
